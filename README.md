...
<b>
An [automatic process](https://github.com/alexandrecuer/colibriScripts) is available for deployment on a linux Ubuntu server or virtual machine. It will install the required dependencies then the application in /var/www/colibri/sharebox.
