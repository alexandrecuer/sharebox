...
The application can use [paperclip](https://github.com/thoughtbot/paperclip) or rails [ActiveStorage](http://guides.rubyonrails.org/active_storage_overview.html) for file storage/documents processing

As paperclip is deprecated, active storage is recommanded for new installations

For existant paperclip installations, a migration guide has to be followed
...
# Installation on a microsoft windows developement machine
